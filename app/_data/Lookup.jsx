export default {
  ...
  HeroSubheading: "Design Stunning Logos Instantly with the Power of AI",
  HeroDesc:
    "Create unique, high-quality logos in seconds using our AI-powered logo generator. Let AI bring your brand identity to life",
  InputTitlePlaceholder: "Enter you Logo Name",
  LogoTitle: "Logo Title",
  LogoTileDesc: "Add Your Business, App, or Website Name for a Custom Logo",
  ...
  LogoIdeaDesc:
    "Choose a design style that align with your vision,or skip to receive a random suggestion.",
