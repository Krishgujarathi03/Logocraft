...
const GenerateLogo = () => {
  ...
  const GenerateAILogo = async () => {
    ...
    console.log("Calling AI logo API with prompt:", PROMPT);
    console.log("Endpoint:", `${window.location.origin}/api/ai-logo-model`);

    const result = await axios.post(
      `${window.location.origin}/api/ai-logo-model`,
      {
        prompt: PROMPT,
